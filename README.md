# 🌾 UMKMOVE - Platform Digital Promosi UMKM Lokal

## 📖 Deskripsi Proyek
UMKMOVE adalah website yang dikembangkan untuk membantu pelaku Usaha Mikro, Kecil, dan Menengah (UMKM) dalam mempromosikan produk mereka secara digital.  
Melalui platform ini, masyarakat dapat mengenal berbagai produk lokal dengan mudah, sementara pelaku UMKM mendapatkan wadah promosi yang modern, cepat, dan tanpa biaya.

Proyek ini dibuat sebagai bagian dari kegiatan **lomba inovasi digital** untuk mendukung program digitalisasi UMKM di Indonesia.

---

## 🎯 Tujuan Proyek
- Meningkatkan visibilitas produk UMKM melalui media digital.  
- Memberikan kemudahan bagi masyarakat untuk menemukan dan mendukung produk lokal.  
- Mendorong pelaku UMKM agar beradaptasi dengan teknologi dan pemasaran online.  
- Menjadi media pembelajaran kolaboratif dalam pengembangan web.
...
| **Tailwind CSS** | Styling dan layout modern |
| **JavaScript (Vanilla)** | Interaktivitas dan logika data |
| **JSON** | Penyimpanan data UMKM |
| **GitHub Pages** | Hosting gratis dan mudah diakses |
| **Canva / Figma** | Desain tampilan & mockup visual |
